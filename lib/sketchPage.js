...
///////////////////// EVENT HANDLERS /////////////////////////
      ...
      mouseUp : function(x, y, z) {
         ...
         if (this.isClick && isHover() && isFreehandSketch(sk()) && sk().keys) {
...
/*
         case 'K':
	    server.play('videos/kids.MOV');
            break;
         case 'T':
	    server.play('videos/teens_in_vr.mov');
            break;
*/
         case 'n':
...
// TODO: move outside of sketch page
         if(isShowingGuide){
           console.log('hey');
           text('click on the canvas,\nthen click above your last point\nto take a bird\'s eye view', [0.1, 0.1, 0.1], 1, 1);
         }
